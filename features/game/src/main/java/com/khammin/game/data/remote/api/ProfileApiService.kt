...
interface ProfileApiService {
    ...
    suspend fun getLeaderboard(
        @Query("sort[0]") sort: String = "enCurrentPoints:desc",
        ...
        @Query("fields[3]") f3: String = "enCurrentPoints",
        @Query("fields[4]") f4: String = "enWordsSolved",
        @Query("fields[5]") f5: String = "enLastPlayedAt",
